...
SFR( PCA0CPM3,
0xDD ); /* PCA MODULE 3 MODE REGISTER */
SFR( PCA0CPM4,
0xDE ); /* PCA MODULE 4 MODE REGISTER */
SFR(      ACC,
0xE0 ); /* ACCUMULATOR */
SFR(     XBR0,
...
SFR( PCA0CPL3,
0xED ); /* PCA CAPTURE 3 LOW */
SFR( PCA0CPH3,
0xEE ); /* PCA CAPTURE 3 HIGH */
SFR(   RSTSRC,
0xEF ); /* RESET SOURCE */
SFR(        B,
0xF0 ); /* B REGISTER */
...
SFR( PCA0CPL4,
0xFD ); /* PCA CAPTURE 4 LOW */
SFR( PCA0CPH4,
0xFE ); /* PCA CAPTURE 4 HIGH */
SFR(   VDM0CN,
...
SFR16E(  PCA0CP3,
0xEEED ); /* PCA CAPTURE 3 WORD */
SFR16E(  PCA0CP4,
0xFEFD ); /* PCA CAPTURE 4 WORD */
...
SBIT(     CCF3,
0xD8, 3 ); /* PCA0CN.3 - PCA MODULE 3 CAPTURE/COMPARE FLAG */
SBIT(     CCF4,
0xD8, 4 ); /* PCA0CN.4 - PCA MODULE 4 CAPTURE/COMPARE FLAG */
SBIT(       CR,
