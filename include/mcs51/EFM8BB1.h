...
SFR(  PCA0POL,
0x96 ); /* PCA Output Polarity */
SFR(    WDTCN,
0x97 ); /* Watchdog Timer Control*/
SFR(    SCON0,
0x98 ); /* SERIAL PORT CONTROL */
SFR(    SBUF0,
0x99 ); /* SERIAL PORT BUFFER */
SFR(  CMP0CN0,
0x9B ); /* COMPARATOR 0 CONTROL 0 */
SFR(  PCA0CLR,
0x9C ); /* PCA Comparator Clear Control */
SFR(   CMP0MD,
0x9D ); /* Comparator 0 Mode */
SFR( PCA0CENT,
0x9E ); /* PCA Center Alignment Enable */
SFR(   CMP0MX,
0x9F ); /* Comparator 0 Multiplexer Selection */
SFR(       P2,
0xA0 ); /* PORT 2 */
SFR(  SPI0CFG,
...
SFR(   CMP1MX,
0xAA ); /* Comparator 1 Multiplexer Selection */
SFR(   CMP1MD,
0xAB ); /* Comparator 1 Mode */
SFR(   SMB0TC,
0xAC ); /* SMBus 0 Timing and Pin Control */
SFR(  DERIVID,
0xAD ); /* Derivative Identification */
SFR(   LFO0CN,
0xB1 ); /* Low Frequency Oscillator Control */
SFR(  ADC0CN1,
0xB2 ); /* ADC0 Control 1 */
SFR(   ADC0AC,
0xB3 ); /* ADC0 Accumulator Configuration */
SFR(  C2FPDAT,
0xB4 ); /* C2 Flash Programming Data */
SFR( DEVICEID,
0xB5 ); /* Device Identification */
SFR(    REVID,
0xB6 ); /* Revision Identifcation */
SFR(    FLKEY,
0xB7 ); /* Flash Lock and Key */
SFR(       IP,
0xB8 ); /* INTERRUPT PRIORITY */
SFR(   ADC0TK,
0xB9 ); /* ADC0 Burst Mode Track Time */
SFR(   ADC0MX,
0xBB ); /* ADC0 Multiplexer Selection */
SFR(   ADC0CF,
...
SFR(  HFO0CAL,
0xC7 ); /* High Frequency Oscillator 0 Calibration */
SFR(  TMR2CN0,
0xC8 ); /* TIMER 2 CONTROL */
SFR(   REG0CN,
0xC9 ); /* TIMER 2 CONTROL */
SFR(  TMR2RLL,
...
SFR( CRC0AUTO,
0xD2 ); /* CRC0 Automatic Control */
SFR(  CRC0CNT,
0xD3 ); /* CRC0 Automatic Flash Sector Count */
SFR(   P0SKIP,
0xD4 ); /* PORT 0 SKIP */
SFR(   P1SKIP,
0xD5 ); /* PORT 1 SKIP */
SFR(  SMB0ADM,
0xD6 ); /* SMBus 0 Slave Address Mask */
SFR(  SMB0ADR,
0xD7 ); /* SMBus 0 Slave Address */
SFR(  PCA0CN0,
0xD8 ); /* PCA CONTROL */
SFR(   PCA0MD,
0xD9 ); /* PCA MODE */
...
SFR(   CRC0IN,
0xDD ); /* CRC0 Data Input */
SFR(  CRC0DAT,
0xDE ); /* CRC0 Data Output */
SFR(  ADC0PWR,
0xDF ); /* ADC0 Power Control */
SFR(      ACC,
0xE0 ); /* ACCUMULATOR */
SFR(     XBR0,
...
SFR(     EIP1,
0xF3 ); /* EXTERNAL INTERRUPT PRIORITY REGISTER 1 */
SFR(   PRTDRV,
0xF6 ); /* Port Drive Strength */
SFR(  PCA0PWM,
...
SFR16(     TMR2,
0xCC ); /* TIMER 2 COUNTER */
SFR16(   TMR2RL,
0xCA ); /* TIMER 2 CAPTURE REGISTER WORD */
SFR16(     TMR3,
0x94 ); /* TIMER 3 COUNTER */
SFR16(   TMR3RL,
0x92 ); /* TIMER 3 CAPTURE REGISTER WORD */
SFR16(     ADC0,
0xBD ); /* ADC 0 DATA WORD */
SFR16(   ADC0GT,
0xC3 ); /* ADC 0 GREATER-THAN REGISTER WORD */
SFR16(   ADC0LT,
0xC5 ); /* ADC 0 LESS-THAN REGISTER WORD */
SFR16(     PCA0,
0xF9 ); /* PCA COUNTER */
SFR16(  PCA0CP0,
...
SBIT(   TF2CEN,
0xC8, 4 ); /* TMR2CN.5 - TIMER 2 CAPTURE ENABLE */
SBIT(   TF2LEN,
...
0xE8, 5 ); /* ADC0CN.5 - ADC 0 CONV. COMPLETE INT. FLAG */
SBIT(   ADBMEN,
0xE8, 6 ); /* ADC0CN.6 - ADC 0 BURST MODE ENABLE */
SBIT(     ADEN,
