...
__sfr __at(0x91)
SBCON0;  /* BAUDRATE GENERATOR 0 CONTROL                  */
__sfr __at(0x93)
SBRLL0;  /* BAUDRATE GENERATOR 0 RELOAD VALUE - LOW BYTE  */
__sfr __at(0x94)
SBRLH0;  /* BAUDRATE GENERATOR 0 RELOAD VALUE - HIGH BYTE */
__sfr __at(0x96)
...
ACC;  /* ACCUMULATOR                                   */
__sfr __at(0xE2)
GPIOCN;  /* GLOBAL PORT I/O CONTROL                       */
__sfr __at(0xE3)
...
__sfr16 __at(0x9493)
SBRL0;  /* BAUDRATE GENERATOR 0 RELOAD VALUE WORD        */
...
__sbit __at(0x9A)
RBX0;  /* SCON.2 - EXTRA RECEIVE BIT                    */
__sbit __at(0x9B)
TB8;  /* SCON.3 - TRANSMIT BIT 8                       */
__sbit __at(0x9B)
TBX0;  /* SCON.3 - EXTRA TRANSMIT BIT                   */
__sbit __at(0x9C)
REN;  /* SCON.4 - RECEIVE ENABLE                       */
__sbit __at(0x9C)
REN0;  /* SCON.4 - RECEIVE ENABLE                       */
__sbit __at(0x9E)
PERR0;  /* SCON.6 - PARITY ERROR FLAG                    */
__sbit __at(0x9F)
OVR0;  /* SCON.7 - RECEIVE FIFO OVERRUN FLAG            */
