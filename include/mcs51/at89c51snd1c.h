...
NVERS;
__sfr __at(0x8F)
CKCON; /* PLL and System Clock SFRs */
__sfr __at(0xE9)
PLLCON;
__sfr __at(0xEE)
PLLNDIV;
...
MMCLK;
__sfr __at(0xF9)
DAT16H; /* IDE Interface SFR */
__sfr __at(0x98)
SCON; /* Serial I/O Port SFRs */
__sfr __at(0x99)
SBUF;
__sfr __at(0xB9)
SADEN;
...
BRL;
__sfr __at(0xC3)
SPCON; /* SPI Controller SFRs */
__sfr __at(0xC4)
SPSTA;
__sfr __at(0xC5)
SPDAT;
__sfr __at(0x93)
SSCON; /* Two Wire Controller SFRs */
__sfr __at(0x94)
SSSTA;
__sfr __at(0x95)
SSDAT;
...
SSADR;
__sfr __at(0xA3)
KBCON; /* Keyboard Interface SFRs */
__sfr __at(0xA4)
KBSTA;
__sfr __at(0xF3)
ADCON; /* A/D Controller SFRs */
__sfr __at(0xF4)
ADDL;
__sfr __at(0xF5)
ADDH;
