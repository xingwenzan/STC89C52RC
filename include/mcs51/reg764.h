...
__sfr __at
0x95
DIVM;   // CPU clock divide by N control
__sfr __at
0x98
SCON;   // Serial Control
__sfr __at
...
__sfr __at
0xA2
AUXR1;   // Auxilliary 1 (not available on 80C51FA/87C51Fx)
__sfr __at
0xA4
...
__sfr __at
0xB9
SADEN;   // Serial slave Address Mask
...
__sbit __at
0xAD
EBO; // Brownout Interrupt Enable
__sbit __at
0xAE
EWD; // Watchdog Interrupt Enable
__sbit __at
0xAF
...
__sbit __at
0xBD
PBO; // Brownout Interrupt Priority
__sbit __at
0xBE
PWD; // Watchdog Interrupt Priority

/*  I2CFG */
__sbit __at
0xC8
CT0; // Clock Time Select 0
__sbit __at
0xC9
CT1; // Clock Time Select 1
__sbit __at
0xCC
TIRUN; // Timer I Run Enable
__sbit __at
0xCD
CLRTI; // Clear Timer I
__sbit __at
...
__sbit __at
0xDA
STP; // Stop Detect Flag
__sbit __at
0xDB
STR; // Start Detect Flag
__sbit __at
0xDC
ARL; // Arbitration Loss Flag
__sbit __at
0xDD
DRDY; // Data Ready Flag
__sbit __at
0xDE
ATN; // Attention: I2C Interrupt Flag
__sbit __at
0xDF
RDAT; // I2C Read Data
...
__sbit __at
0xE8
EI2; // I2C Interrupt Enable
__sbit __at
0xE9
EKB; // Keyboard Interrupt Enable
__sbit __at
0xEA
EC2; // Comparator 2 Interrupt Enable
__sbit __at
0xED
EC1; // Comparator 1 Interrupt Enable
__sbit __at
0xEF
ETI; // Timer I Interrupt Enable
...
__sbit __at
0xF8
PI2; // I2C Interrupt Priority
__sbit __at
0xF9
PKB; // Keyboard Interrupt Priority
__sbit __at
0xFA
PC2; // Comparator 2 Interrupt Priority
__sbit __at
0xFD
PC1; // Comparator 1 Interrupt Priority
__sbit __at
0xFF
PTI; // Timer I Interrupt Priority
