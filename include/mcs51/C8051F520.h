...
0x90, 7); // Port 1 bit 7
SFR(LINADDR,
0x92);      // LIN Indirect Address Pointer
SFR(LINDATA,
0x93);      // LIN Indirect Data Buffer
SFR(LINCF,
0x95);      // LIN Control Mode
SFR(SCON0,
...
0xA9);      // Clock Select
SFR(OSCIFIN,
0xB0);      // Internal Oscillator Fine Calibration
SFR(OSCXCN,
...
SFR(ADC0TK,
0xBA);      // ADC0 Tracking Mode Select
SFR(ADC0MX,
0xBB);      // ADC0 Channel Select
SFR(ADC0CF,
...
SFR(REG0CN,
0xC9);      // Voltage Regulator Control
SFR16(TMR2RL,
...
SBIT(AD0LJST,
0xE8, 2); // ADC0 Left Justify Select
SBIT(AD0WINT,
...
SBIT(BURSTEN,
0xE8, 6); // ADC0 Burst Mode Enable Bit
SBIT(AD0EN,
...
SFR(EIP1,
0xF6);      // Extended Interrupt Priority 1
SFR(SPI0CN,
0xF8);      // SPI0 Control
SBIT(SPIEN,
0xF8, 0); // SPI0 Enable
