...
__sfr __at(0x8E)
AUXR;        //Auxiliary function register (Reset value 0x00).
#define EXTRAM 0x02        //'0'=uses internal XRAM.
#define AO 0x01            //'1'=Disables ALE generation.

__sfr __at(0xA2)
AUXR1;    //Auxiliary function register 1 (Reset value 0x00).
...
__sfr __at(0xD8)
CCON;    //PCA Counter Control (Reset value 0x00)
__sbit __at(0xDF)
CF;    //PCA Counter overflow flag.
__sbit __at(0xDE)
CR; //PCA Counter Run Control Bit. 1=counter on.  0=counter off.
__sbit __at(0xDC)
...
__sbit __at(0xEB)
EBO; //Brown-out Interrupt Enable. (Vector is 0x00b4).

//Attention IP0 is the same as register IP found in <8051.h> only bit PPC added here.
__sfr __at(0xB8)
IP0;        //Interrupt Priority 0 HIGH.
__sbit __at(0xBE)
PPC;    //PCA Interrupt Priority low bit.
...
__sfr __at(0xD5)
SPCR;        //SPI Control Register (Reset value 00000000B).
__sfr __at(0xD5)
SPCTL;    //SPI Control Register (This name appears also in the datasheet).
...
__sfr __at(0xAA)
SPSR;        //SPI Configuration Register (Reset value 00000000B).
__sfr __at(0xAA)
SPCFG;    //SPI Configuration Register (This name appears also in the datasheet).
...
SPDR;        //SPI Data
__sfr __at(0x86)
SPDAT;    //SPI Data (This name appears also in the datasheet).

__sfr __at(0xC0)
WDTC;        //Watchdog Timer Control (Reset value 0x00).
__sbit __at(0xC4)
