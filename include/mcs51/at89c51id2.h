...
__sfr __at(0x94)
SSCS;     // Synchronous Serial Control and Status Register (read) (094h)
...
__sfr __at(0x95)
SSDAT;    // Synchronous Serial Data register (read/write) (095h)
__sfr __at(0x96)
SSADR;    // Synchronous Serial Address Register (read/write) (096h)
