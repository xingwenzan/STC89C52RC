...
const u8 tab[] = {
        0x86, 0x8C, 0x98, 0xBF, 0xE0, 0xC8, 0x84, 0x82,   // 不
        0xE9, 0x4A, 0x7C, 0x4B, 0x3C, 0x24, 0x24, 0x3C,   // 知
        0x40, 0x82, 0xFA, 0xAA, 0xAA, 0x8A, 0xC9, 0x8F,   // 写
        0x10, 0x20, 0x7F, 0x80, 0x10, 0xFF, 0x10, 0x10,   // 什
        0x12, 0x26, 0x4A, 0x92, 0x22, 0x02, 0x02, 0x07,   // 么
};  // 图案
